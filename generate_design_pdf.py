...
def build_pdf():
    ...
    style_diag_title = ParagraphStyle(
        'DiagTitle',
        fontName='SegoeUI-Bold',
        fontSize=8.5,
        leading=11,
    ...
    style_diag_header = ParagraphStyle(
        'DiagHeader',
        fontName='SegoeUI-Bold',
        fontSize=8,
        leading=10,
    ...
    style_diag_text = ParagraphStyle(
        'DiagText',
        fontName='SegoeUI',
        fontSize=6.8,
        leading=8.5,
    ...
    style_diag_arrow = ParagraphStyle(
        'DiagArrow',
        fontName='SegoeUI-Bold',
        fontSize=7.2,
        leading=9,
    ...
    # ==================================================================
    # PAGE 3: TWO-ACCOUNT ARCHITECTURE & DATABASE SCHEMA
    # ==================================================================
